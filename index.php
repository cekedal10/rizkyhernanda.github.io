      ...
      <div class="header-wrap d-flex flex-column justify-content-between h-100">
        <div class="navigation">
          <div class="site-logo mt-5">
            <a href="index.php">
              <h1 style="font-family: hanson">RIZKY.io</h1>
            </a>
          </div>
          ...
          <nav id="one-page-menu" class="vertical-menu my-5">
            <ul class="menu-list list-unstyled">
              ...
              <li><a href="#about" class="nav-link">Riwayat</a></li>
              <li><a href="#experience" class="nav-link">Skill Aktif</a></li>
        ...
        <div class="mt-5">
          <div class="email-links">
            <a href="mailto:riezkyhernanda@gmail.com" class="py-3 my-3 border-bottom d-flex">riezkyhernanda@gmail.com</a>
          </div>
    ...
    <main class="col-lg-10 offset-lg-2">
      <div class="container">
        ...
        <div class="justify-content-center px-1 mx-1 px-xl-5 mx-xl-5">
          ...
          <section id="home" class="py- bg-text" data-text="01">
            <div class="row">
              <div class="col-lg-6">
                <div class="banner-image text-center" data-aos="fade-right">
                    ...
                    <br>
                    <br>
                  <img src="images/pp.jpg" width="426" height="589">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="banner-content my-1 pt-1 my-lg-5 pt-lg-5" data-aos="fade-in">
                  ...
                  <h1 class="banner-title display-xl lh-1 txt-fx slide-up">Rizky Hernanda</h1>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                  <span>02</span>
                  <h3 class="sub-heading">Illustration</h3>
                  <p>lorem ipsum.</p>
                </div>
              </div>
              <div class="col-lg-3">
          ...
          <section id="about" class="my-4 py-5 bg-text" data-text="02">
            <div class="row d-flex flex-wrap" data-aos="fade-up">
              <div class="col-lg-6 pb-5">
                <span class="text-muted text-uppercase">BIODATA</span>
                <h2 class="display-4 txt-fx slide-up" style="font-size: 45px">Riwayat Pendidikan</h2>
                <div class="data-info py-3" data-aos="fade-up">
                  <span class="meta-date">2020 - 2025</span>
                  <h3 class="info-title">S1 Teknik Informatika</h3>
                  <p>Universitas Ubudiyah Indonesia</p>
                </div>
                <div class="data-info" data-aos="fade-up" data-aos-delay="100">
                  <span class="meta-date">2025 - 2028</span>
                  <h3 class="info-title">Magister Hukum</h3>
                  <p>Universitas Gadjah Mada Yogyakarta</p>
                </div>
              </div>
              <div class="col-lg-6 py-4">
                <h2 class="display-4 txt-fx slide-up" style="font-size: 45px">Riwayat Organisasi</h2>
                <div class="data-info py-3" data-aos="fade-up" data-aos-delay="200">
                  <span class="meta-date">2023 - 2024</span>
                  <h3 class="info-title">Sekretaris Jenderal PEMA </h3>
                  <p>PEMA adalah Pemerintahan Mahasiswa di Universitas Ubudiyah Indonesia</p>
                </div>
                <div class="data-info" data-aos="fade-up" data-aos-delay="300">
                  <span class="meta-date">2024 - 2025</span>
                  <h3 class="info-title">Koordinator Daerah PERMIKOMNAS RI</h3>
                  <p>Permikomnas (Perhimpunan Mahasiswa Informatika dan Komputer Nasional) adalah suatu lembaga wadah bagi Himpunan yang tergabung kedalam lembaga tersebut.</p>
                </div>
              </div>
            </div>
          ...
          <section id="experience" class="my-5 py-5 bg-text" data-text="03">
            <div class="row justify-content-center mb-5">
              <div class="col-lg-6" data-aos="fade-up">
                ...
                <h2 class="display-1 txt-fx slide-up">Skill Yang Dikuasai</h2>
                ...
                <div class="info-element py-4" data-aos="fade-up">
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <th>Alamat</th>
                        <td>Jl. Geulumpang Jl. Puklat No.15, Meunasah Papeun, Kec. Krueng Barona Jaya, Kabupaten Aceh Besar </td>
                      </tr>
                      <tr>
                        <th>E-mail</th>
                        <td><a href="#">riezkyhernanda@gmail.com</a></td>
                      </tr>
                      <tr class="no-border-bottom">
                        <th>Phone</th>
                        <td>+62853 - 7392 - 1089</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="col-lg-6">
                <div class="skill-chart py-4" data-aos="fade-up">
                  <ul class="skill-chart-list list-unstyled">
                    ...
                    <li>
                      <div class="chart-header d-flex justify-content-between">
                        <span class="skill-title">Blender Animasi</span>
                    ...
                    <li>
                      <div class="chart-header d-flex justify-content-between">
                        <span class="skill-title">Android Studio</span>
                    ...
                    <li>
                      <div class="chart-header d-flex justify-content-between">
                        <span class="skill-title">Microsoft Office</span>
          ...
          <section id="portfolio" class="my-5 py-5 bg-text" data-text="04">
            <div class="section-header my-5" data-aos="fade-up">
              <div class="row justify-content-center g-5">
                <div class="col-lg-5">
                  <span class="text-muted text-uppercase">pekerjaan yang pernah dikerjakan</span>
                  <h2 class="display-2 txt-fx slide-up">Portfolio</h2>
                </div>
                <div class="col-lg-4" data-aos="fade-up">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
                  <a href="https://cekedal10.github.io/" class="btn btn-dark px-5 py-4">View All</a>
                </div>
              </div>
            </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="image-holder">
                    <a href="#portfolio" title="portfolio details"><img src="images/port-item1.jpg"
                        alt="portfolio" class="img-fluid"></a>
                  </div>
                  <div class="caption d-flex justify-content-between align-items-center">
                    <div class="title">Gambar contoh 1</div>
                    <a href="#" class="image-format bg-orange">svg</a>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="image-holder">
                    <a href="#portfolio" title="portfolio details"><img src="images/port-item2.jpg"
                        alt="portfolio" class="img-fluid"></a>
                  </div>
                  <div class="caption d-flex justify-content-between align-items-center">
                    <div class="title">Gambar contoh 2</div>
                    <a href="#" class="image-format bg-orange">svg</a>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="image-holder">
                    <a href="#portfolio" title="portfolio details"><img src="images/port-item3.jpg"
                        alt="portfolio" class="img-fluid"></a>
                  </div>
                  <div class="caption d-flex justify-content-between align-items-center">
                    <div class="title">Gambar contoh 3</div>
                    <a href="#" class="image-format bg-blue">psd</a>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="image-holder">
                  ...
                  <div class="accordion" id="accordionExample2">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingTwo">
                        ...
                        Bagaimana kami bisa melakukan akses ke portfolio?
                        </button>
                      </h2>
                ...
                <div class="col-lg-5">
                  <div class="right-content" data-aos="fade-up">
                    ...
                    <div class="element-header align-right">
                      <h3>Hubungi Kami Jika </h3>
                    </div>

                    <div class="contact-form py-4">
                      <form id="form" class="form-group">
                        <div class="pb-2"><input type="text" name="name" placeholder="Nama Lengkap"
                            class="form-control">
                        </div>
                        <div class="pb-2"><input type="text" name="address" placeholder="Alamat Email"
                            class="form-control"></div>
                        <div class="pb-2"><textarea placeholder="Pesan" rows="6" class="form-control"></textarea>
                        </div>
